...
def data_load_fun():
    ...
    #df_time = pd.date_range('2014-01-07 ', '2017-05-31', freq='1min')
    #data1 = pd.DataFrame(data=data, index=df_time)
    #print(len(data1))
    #print("data1  : ", data1)
    ...
    #print(data)
    t,p, a = prepare_model(volume1,openp,lowp, data, timestamp)
    ## print(" ended!!!! ")
    return t, p, a
